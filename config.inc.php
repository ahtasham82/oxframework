 ...
 */
    ...
    $this->dbName = 'oxframework'; // database name
    $this->dbUser = 'root'; // database user name
    $this->dbPwd = ''; // database user password
    $this->dbType = 'mysql';
    $this->sShopURL = 'http://oxframework'; // eShop base url, required
    $this->sSSLShopURL  = null;            // eShop SSL url, optional
    $this->sAdminSSLURL = null;            // eShop Admin SSL url, optional
    $this->sShopDir = 'C:/wamp/www/mine/oxframework';
    $this->sCompileDir = 'C:/wamp/www/mine/oxframework/tmp';
     ...
     */
    $this->captchaKey = 'e194fe7619290c8abf6b299a11838df4';
